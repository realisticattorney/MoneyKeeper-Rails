...
RSpec.describe 'records API' do
  ...
  describe 'GET /accounts/:account_id/records/:id' do
    before { get "/accounts/#{account_id}/records/#{id}", params: {}, headers: headers }
  ...
  describe 'POST /accounts/:account_id/records' do
    ...
    context 'when request attributes are valid' do
      before do
        post "/accounts/#{account_id}/records", params: valid_attributes, headers: headers
      end
  ...
  describe 'DELETE /accounts/:id' do
    before { delete "/accounts/#{account_id}/records/#{id}", params: {}, headers: headers }
